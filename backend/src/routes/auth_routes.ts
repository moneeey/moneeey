...
router.post(
  '/start',
  HandleAPI(authController.logger, (req, _res) => authController.start(req.body['email'].toLowerCase()))
);
router.post(
  '/check',
...
router.post(
  '/complete',
  HandleAPI(authController.logger, (req, _res) =>
    authController.complete(req.body['email'].toLowerCase(), req.body['auth_code'], req.body['confirm_code'])
  )
);
router.post(
  '/logout',
  HandleAPI(authController.logger, (req, _res) =>
    authController.logout(req.body['email'].toLowerCase(), req.body['auth_code'])
  )
);
