...
export const BudgetAllocatedEditor = observer(<EntityType,>(props: EditorProps<EntityType, number, number>) => {
  ...
  return (
    <NumberEditor
      {...{
        ...
        value: currency ? (currencies.formatAmount(currency, entity.allocated) as unknown as number) : entity.allocated,
        onUpdate: (value: number) => budget.setAllocation(entity.budget, entity.starting, isNaN(value) ? 0 : value),
      }}
    />
  )
})
