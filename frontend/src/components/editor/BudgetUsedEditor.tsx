...
export const BudgetUsedEditor = observer(<EntityType,>(props: EditorProps<EntityType, number, number>) => {
  ...
  return (
    <NumberEditor
      {...{
        ...
        value: currency ? (currencies.formatAmount(currency, entity.used) as unknown as number) : entity.used,
      }}
    />
  )
})
