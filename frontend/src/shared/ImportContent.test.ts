...
describe('ImportContent', () => {
  describe('txt/csv', () => {
    ...
    it('findColumns unrelated number', () => {
      expect(findColumns(['Hello World', 'I helped 123,87 friends to do 321.98 things', '42,69', '23/12/2022'], 'dd/MM/yyyy')).toEqual({
        valueIndex: 2,
        dateIndex: 3,
      })
    })
    ...
    it('retrieve columns', () => {
      ...
      expect(retrieveColumns(['Hello World', '42,69', '23/12/2022', 'something', '123141', 'else'], indexes, 'dd/MM/yyyy')).toEqual({
        value: 42.69,
        date: '2022-12-23',
