...
describe("ImportContent", () => {
	it("MostCommonDateFormats", () =>
		expect(
			MostCommonDateFormats.map(
				(pattern) =>
					`${pattern} -> ${formatDateFmt(new Date(2024, 11, 29, 22, 33, 44, 567), pattern)}`,
			),
		).toMatchInlineSnapshot(`
[
  "yyyy-MM-dd'T'HH:mm:ss.SSSXXX -> 2024-12-29T22:33:44.567-03:00",
  "yyyy-MM-dd'T'HH:mm:ss.SSS'Z' -> 2024-12-29T22:33:44.567Z",
  "yyyy-MM-dd'T'HH:mm:ss.SSSXXX -> 2024-12-29T22:33:44.567-03:00",
  "yyyy-MM-dd HH:mm:ss.SSS'Z' -> 2024-12-29 22:33:44.567Z",
  "yyyy-MM-dd'T'HH:mm:ss.SSS -> 2024-12-29T22:33:44.567",
  "yyyy-MM-dd'T'HH:mm:ss.SSS -> 2024-12-29T22:33:44.567",
  "yyyy-MM-dd'T'HH:mm:ss.SSSS -> 2024-12-29T22:33:44.5670",
  "yyyy-MM-dd HH:mm:ss.SSSS -> 2024-12-29 22:33:44.5670",
  "yyyy-MM-dd'T'HH:mm:ssXXX -> 2024-12-29T22:33:44-03:00",
  "yyyy-MM-dd'T'HH:mm:ss'Z' -> 2024-12-29T22:33:44Z",
  "yyyy-MM-dd HH:mm:ss.S'Z' -> 2024-12-29 22:33:44.5Z",
  "yyyy-MM-dd'T'HH:mm:ss.SSS -> 2024-12-29T22:33:44.567",
  "yyyy-MM-dd HH:mm:ss.SSS -> 2024-12-29 22:33:44.567",
  "yyyyMMdd'T'HHmm'Z'.SSS'Z' -> 20241229T2233Z.567Z",
  "yyyy-MM-dd'T'HH:mm:ss.S -> 2024-12-29T22:33:44.5",
  "yyyy-MM-dd'T'HH:mm:ss'Z' -> 2024-12-29T22:33:44Z",
  "yyyy-MM-dd'T'HH:mm:ssXXX -> 2024-12-29T22:33:44-03:00",
  "yyyy-MM-dd'T'HH:mm:ss.SS -> 2024-12-29T22:33:44.56",
  "yyyy-MM-dd'T'HH:mm:ss'Z' -> 2024-12-29T22:33:44Z",
  "yyyy-MM-dd'T'HH:mm:ss'Z' -> 2024-12-29T22:33:44Z",
  "yyyy-MM-dd HH:mm:ss.SS -> 2024-12-29 22:33:44.56",
  "yyyy-MM-dd HH:mm:ss.SS -> 2024-12-29 22:33:44.56",
  "yyyy-MM-dd HH:mm:ss.S -> 2024-12-29 22:33:44.5",
  "yyyyMMdd'T'HHmmss.SS'Z' -> 20241229T223344.56Z",
  "yyyy-MM-dd'T'HH:mm:ss.s -> 2024-12-29T22:33:44.44",
  "yyyyMMdd'T'HHmmss.SS'Z' -> 20241229T223344.56Z",
  "yyyy-MM-dd HH:mm:ss.S -> 2024-12-29 22:33:44.5",
  "yyyyMMdd'T'HHmmss'Z'.S -> 20241229T223344Z.5",
  "dd-MMM-yyyy HH:mm:ss -> 29-Dec-2024 22:33:44",
  "yyyyMMdd'T'HHmmss.S'Z' -> 20241229T223344.5Z",
  "yyyy-MM-dd'T'HH:mm:ss -> 2024-12-29T22:33:44",
  "yyyy-MM-dd'T'HH:mm:ss -> 2024-12-29T22:33:44",
  "yyyy.MM.dd HH:mm:ss -> 2024.12.29 22:33:44",
  "dd/MM/yyyy HH:mm:ss -> 29/12/2024 22:33:44",
  "MM/dd/yyyy HH:mm:ss -> 12/29/2024 22:33:44",
  "yyyy-MM-dd HH:mm:ss -> 2024-12-29 22:33:44",
  "yyyy-MM-dd'T'HH:mm:ss -> 2024-12-29T22:33:44",
  "yyyyMMdd'T'HHmm'Z'.SS -> 20241229T2233Z.56",
  "dd.MM.yyyy HH:mm:ss -> 29.12.2024 22:33:44",
  "yyyyMMdd'T'HHmmSSS.SS -> 20241229T2233567.56",
  "dd/MM/yyyy HH'h'mm -> 29/12/2024 22h33",
  "MM/dd/yyyy HH'h'mm -> 12/29/2024 22h33",
  "yyyy-MM-dd HH'h'mm -> 2024-12-29 22h33",
  "yyyy/MM/dd HH'h'mm -> 2024/12/29 22h33",
  "dd.MM.yyyy HH'h'mm -> 29.12.2024 22h33",
  "yyyyMMdd'T'HHmmss'Z' -> 20241229T223344Z",
  "yyyyMMdd'T'HHmmss'Z' -> 20241229T223344Z",
  "yyyyMMdd'T'HHmmss'Z' -> 20241229T223344Z",
  "yyyyMMdd'T'HHmmss.SS -> 20241229T223344.56",
  "yyyyMMdd'T'HHmmss.SS -> 20241229T223344.56",
  "yyyyMMdd'T'HHmmss.S -> 20241229T223344.5",
  "yy/MM/dd HH:mm:ss -> 24/12/29 22:33:44",
  "yyyyMMddHHmmss.SS -> 20241229223344.56",
  "dd/MM/yyyy HH:mm -> 29/12/2024 22:33",
  "MM/dd/yyyy HH:mm -> 12/29/2024 22:33",
  "yyyy-MM-dd HH:mm -> 2024-12-29 22:33",
  "yyyy/MM/dd HH:mm -> 2024/12/29 22:33",
  "dd.MM.yyyy HH:mm -> 29.12.2024 22:33",
  "yyyyMMdd'T'HHmm'Z' -> 20241229T2233Z",
  "yyyyMMdd'T'HHmm'Z' -> 20241229T2233Z",
  "yyyy-MM-dd HH:mm -> 2024-12-29 22:33",
  "yyyyMMdd'T'HHmm'Z' -> 20241229T2233Z",
  "yyyyMMdd'T'HHmmSSS -> 20241229T2233567",
  "yyyyMMddHHmmSSS -> 202412292233567",
  "yyyyMMdd'T'HHmmSS -> 20241229T223356",
  "yyyyMMdd'T'HHmmSS -> 20241229T223356",
  "yyyyMMddHHmmSSS -> 202412292233567",
  "yyyyMMdd'T'HHmmSS -> 20241229T223356",
  "MMMM dd, yyyy -> December 29, 2024",
  "Do MMMM, yyyy -> 364th December, 2024",
  "yyyyMMdd'T'HHmm -> 20241229T2233",
