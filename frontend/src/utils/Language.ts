export default {
	menu: {
		title: { en: "Moneeey", pt: "Moneeey", es: "Moneeey", in: "मनी", cn: "钱" },
		search: {
			en: "Search",
			pt: "Pesquisar",
			es: "Buscar",
		...
		unassigned: {
			...
			in: (amount: number) => `असाइन नहीं किया गया (${amount})`,
		...
		balance: {
			...
			in: (amount: string) => `शेष राशि: ${amount}`,
	...
	landing: {
		failed: {
			...
			in: "लॉगिन विफल, कृपया पुनः प्रयास करें",
			cn: "登录失败，请重试",
		},
		welcome: {
	...
	login: {
		completed: {
			...
			in: "स्वागत है, कृपया प्रतीक्षा करें...",
			cn: "欢迎，请稍候...",
		},
		auth_code: {
			...
			in: "गलत प्रमाणीकरण कोड, कृपया पुनः प्रयास करें",
			cn: "错误的认证代码，请重试",
		},
		confirm_code: {
			...
			in: "गलत पुष्टि कोड, कृपया पुनः प्रयास करें",
			cn: "错误的确认代码，请重试",
		},
		code_expired: {
			...
			in: "पुष्टि कोड समाप्त हो गया, कृपया पुनः प्रयास करें",
			cn: "确认代码已过期，请重试",
		},
		login_or_signup: {
			en: "Login or Sign up",
	...
	import: {
		...
		click_or_drop_here: {
			...
			in: "यहाँ फाइलों को खींचें और छोड़ें, या फाइलें चुनने के लिए क्लिक करें",
			cn: "拖放文件到这里，或点击选择文件",
		},
		supported_formats: {
			...
			in: "समर्थित प्रारूप: TXT, CSV, OFX, PDF",
		...
		unknown_mode: {
			...
			in: (mode: string) => `अज्ञात मोड ${mode}`,
		...
		changed_description: {
			...
			es: (from_value: string, to_value: string) =>
				`Cambiado de\n${from_value}\na\n${to_value}`,
			in: (from_value: string, to_value: string) =>
				`${from_value}\nसे बदलकर\n${to_value}\nकिया गया`,
	...
	settings: {
		...
		reload_page: {
			...
			in: "अपने पृष्ठ को पुनः लोड करें",
			cn: "重新加载页面",
		},
		export_data: {
			en: "Export data",
		...
		restore_data_placeholder: {
			...
			in: "यहाँ अपने पुनर्स्थापना डेटा को पेस्ट करें और 'डेटा पुनर्स्थापित करें' पर फिर से क्लिक करें",
		...
		clear_data_placeholder: {
			...
			in: "इस टेक्स्ट क्षेत्र में 'सब कुछ हटा दें' टाइप करें और फिर 'डेटा साफ़ करें' दबाएँ ताकि सब कुछ हट जाए और शुरुआत से शुरू किया जा सके।",
	...
	merge_accounts: {
		...
		description: {
			...
			in: "दो खातों को एक में मर्ज करें, स्रोत खाते से सभी लेन-देन को लक्ष्य खाते में स्थानांतरित करें।",
		...
		target: {
			...
			in: "लक्ष्य खाता (जिसमें मर्ज किया गया)",
			cn: "目标账户（已合并）",
		},
		success: {
			...
			in: "खाते सफलतापूर्वक मर्ज किए गए",
			cn: "账户合并成功",
		},
	},
	...
	sync: {
		intro: {
			...
			in: "अपने डेटा को सिंक्रनाइज़ करने से आप कई उपकरणों पर रियल-टाइम में मनी का उपयोग कर सकते हैं, यहां तक कि सहयोग का समर्थन भी कर सकते हैं।",
		...
		login_started: {
			...
			in: "एक पुष्टि ईमेल भेजी गई है। कृपया लिंक पर क्लिक करके पुष्टि करें।",
			cn: "确认邮件已发送。请点击链接确认。",
		},
		login_error: {
			...
			in: "लॉगिन पुष्टि ईमेल भेजने में असमर्थ।",
			cn: "无法发送登录确认邮件。",
		},
		couchdb_url: {
			en: "CouchDB URL",
	...
	tour: {
		...
		continue_language: {
			...
			in: "डिफ़ॉल्ट मुद्रा चयन पर जारी रखें",
			cn: "继续选择默认货币",
		},
		continue_currency: {
		...
		import: {
			...
			in: "आप सामान्य बैंकिंग प्रारूपों से लेन-देन आयात कर सकते हैं।",
			cn: "您可以从常见的银行格式导入交易。",
		},
		currencies: {
			...
			in: "मनी बहु-मुद्रा समर्थित है! हमने दुनिया की 50 सबसे अधिक उपयोग की जाने वाली मुद्राएँ जोड़ी हैं। आप उन्हें अपनी आवश्यकताओं के अनुसार जोड़ या अनुकूलित कर सकते हैं!",
		...
		accounts: {
			...
			in: "इस अनुभाग में अपने खातों का प्रबंधन करें। आप नए खाते जोड़ सकते हैं, मुद्राएँ बदल सकते हैं और खातों को संग्रहीत कर सकते हैं।",
		...
		transactions: {
			...
			in: "मनी आपके लेन-देन के आधार पर रिपोर्ट और अंतर्दृष्टि उत्पन्न करता है। नाम टाइप करके और 'बनाएँ' चुनकर आसानी से नए प्राप्तकर्ता जोड़ें।",
		...
		budgets: {
			...
			in: "अब अपने मनी का बजट बनाएं! अपनी आय के हिस्सों को बजट में आवंटित करें और अपने वित्तीय लक्ष्यों को ट्रैक करें।",
		...
		your_turn: {
			...
			in: "अब आपकी बारी है! वास्तविक अंतर्दृष्टि प्राप्त करने के लिए लेन-देन जोड़ना शुरू करें।",
		...
		please_create_budget: {
			...
			in: "जारी रखने से पहले, 'नया बजट' पर क्लिक करें और एक बजट बनाएं।",
		...
		please_create_account: {
			...
			in: "जारी रखने से पहले, नीचे विवरण दर्ज करके एक खाता बनाएँ।",
