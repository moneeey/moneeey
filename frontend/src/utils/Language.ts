export default {
	...
	encryption: {
		...
		signin_magic_link: {
			en: "Sign in with email (magic link)",
			pt: "Entrar com e-mail (link mágico)",
			es: "Iniciar sesión con correo (enlace mágico)",
			hi: "ईमेल से साइन इन करें (मैजिक लिंक)",
			cn: "使用邮箱登录（魔法链接）",
		},
		signin_self_hosted: {
		...
		magic_link_description: {
			en: "Enter the email you used for Moneeey. We'll send a sign-in link.",
			pt: "Digite o e-mail que você usou no Moneeey. Enviaremos um link de acesso.",
			es: "Ingrese el correo que usó para Moneeey. Le enviaremos un enlace de acceso.",
			hi: "वह ईमेल दर्ज करें जिसका उपयोग आपने मनी के लिए किया था। हम साइन-इन लिंक भेजेंगे।",
			cn: "输入您用于 Moneeey 的邮箱。我们将发送登录链接。",
		},
		...
		waiting_for_magic_link: {
			en: "Check your email and click the sign-in link. We're watching for it…",
			pt: "Verifique seu e-mail e clique no link de acesso. Estamos aguardando…",
			es: "Revise su correo y haga clic en el enlace de acceso. Estamos esperando…",
			hi: "अपना ईमेल जांचें और साइन-इन लिंक पर क्लिक करें। हम प्रतीक्षा कर रहे हैं…",
			cn: "请检查您的邮箱并点击登录链接。我们正在等待…",
		},
