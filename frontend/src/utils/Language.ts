export default {
	...
	encryption: {
		...
		passkey_description: {
			en: "Sign in or create an account with your device's biometrics or security key.",
			pt: "Entre ou crie uma conta com a biometria ou chave de segurança do seu dispositivo.",
			es: "Inicie sesión o cree una cuenta con la biometría o clave de seguridad de su dispositivo.",
			hi: "अपने डिवाइस की बायोमेट्रिक्स या सुरक्षा कुंजी से साइन इन करें या खाता बनाएँ।",
			cn: "使用设备的生物识别或安全密钥登录或创建账户。",
		},
		passkey_register: {
			en: "Create account",
			pt: "Criar conta",
		...
		setup_description: {
			en: "Moneeey encrypts everything locally with a passphrase. Choose one now — it cannot be recovered if you forget it.",
			pt: "O Moneeey criptografa tudo localmente com uma senha. Escolha uma agora — ela não pode ser recuperada se você esquecer.",
			es: "Moneeey cifra todo localmente con una contraseña. Elija una ahora — no se puede recuperar si la olvida.",
			hi: "मनी एक पासफ्रेज़ के साथ सब कुछ स्थानीय रूप से एन्क्रिप्ट करता है। अभी एक चुनें — यदि आप इसे भूल जाते हैं तो इसे पुनर्प्राप्त नहीं किया जा सकता है।",
			cn: "Moneeey 使用密码在本地加密所有内容。现在请选择一个密码 — 一旦忘记将无法恢复。",
		},
		setup_warning: {
		...
		unlock_description: {
			en: "Enter your passphrase to decrypt your data.",
			pt: "Digite sua senha para descriptografar seus dados.",
			es: "Ingrese su contraseña para descifrar sus datos.",
			hi: "अपने डेटा को डिक्रिप्ट करने के लिए अपना पासफ्रेज़ दर्ज करें।",
			cn: "输入您的密码以解密您的数据。",
		},
