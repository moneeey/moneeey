...
const Messages: TMessages = {
  ...
  import: {
    ...
    changed_description: (from_value: string, to_value: string) => `Alterado de\n${from_value}\npara\n${to_value}`,
  },
  util: {
    name: 'Nome',
    tags: 'Tags',
  ...
  settings: {
    ...
    backup_loading: (percentage: number) => `Carregando seus dados de backup, por favor aguarde... ${percentage}%`,
    restore_loading: (percentage: number) => `Restaurando seus dados de backup, por favor aguarde... ${percentage}%`,
    restore_data_placeholder: 'Cole seus dados de restauração aqui e clique em "Restaurar dados" novamente',
    clear_data_token: 'EXCLUIR TUDO',
    clear_data_placeholder: 'Digite "EXCLUIR TUDO" nesta área de texto e pressione "Limpar dados" novamente para excluir tudo e começar do zero.',
  ...
  merge_accounts: {
    ...
    description: 'Mesclar duas contas em uma única, movendo todas as transações da conta de origem para a conta de destino.',
